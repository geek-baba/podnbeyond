...
export default function AdminDashboard() {
  ...
  const loadDashboardData = async () => {
    try {
      // In a real app, you'd have a dashboard stats endpoint
      // For now, we'll use mock data
      setStats({
        totalBookings: 42,
        totalRevenue: 125000, // in paise
        occupancyRate: 78,
        availableRooms: 15,
      });
    } catch (error) {
        ...
        <Link href="/admin/rooms" className="block">
          <div className="bg-white p-6 rounded-lg shadow-sm border border-gray-200 hover:shadow-md transition-shadow">
            <div className="flex items-center mb-4">
              ...
              <h3 className="ml-3 text-lg font-semibold text-gray-900">Room Management</h3>
            </div>
        ...
        <Link href="/admin/inventory" className="block">
          <div className="bg-white p-6 rounded-lg shadow-sm border border-gray-200 hover:shadow-md transition-shadow">
            <div className="flex items-center mb-4">
              ...
              <h3 className="ml-3 text-lg font-semibold text-gray-900">Inventory Calendar</h3>
            </div>
            <p className="text-gray-600">View and update room availability</p>
          </div>
        </Link>
        ...
        <Link href="/admin/bookings" className="block">
          <div className="bg-white p-6 rounded-lg shadow-sm border border-gray-200 hover:shadow-md transition-shadow">
            <div className="flex items-center mb-4">
              ...
              <h3 className="ml-3 text-lg font-semibold text-gray-900">Bookings</h3>
            </div>
        ...
        <Link href="/admin/rates" className="block">
          <div className="bg-white p-6 rounded-lg shadow-sm border border-gray-200 hover:shadow-md transition-shadow">
            <div className="flex items-center mb-4">
              ...
              <h3 className="ml-3 text-lg font-semibold text-gray-900">Rate Plans</h3>
            </div>
            <p className="text-gray-600">Configure pricing and rate plans</p>
          </div>
        </Link>

        <Link href="/admin/channel" className="block">
          <div className="bg-white p-6 rounded-lg shadow-sm border border-gray-200 hover:shadow-md transition-shadow">
            <div className="flex items-center mb-4">
              ...
              <h3 className="ml-3 text-lg font-semibold text-gray-900">Channel Manager</h3>
            </div>
            <p className="text-gray-600">Manage OTA integrations and sync</p>
          </div>
        </Link>
